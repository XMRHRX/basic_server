...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const crawlerController_1 = require("./controller/crawlerController");
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const uesrController_1 = require("./controller/uesrController");
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const models = {
    "User": {
        "dataType": "refObject",
...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/crawler/:url', function (request, response, next) {
        const args = {
        ...
        const controller = new crawlerController_1.CrawlerControler();
        const promise = controller.getWeb.apply(controller, validatedArgs);
        promiseHandler(controller, promise, response, undefined, next);
    });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/crawler', function (request, response, next) {
        const args = {
        ...
        const controller = new crawlerController_1.CrawlerControler();
        const promise = controller.crawlPage.apply(controller, validatedArgs);
        promiseHandler(controller, promise, response, undefined, next);
    });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/users/:userID', function (request, response, next) {
        ...
        const controller = new uesrController_1.UserController();
