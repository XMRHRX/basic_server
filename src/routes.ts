...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { CrawlerControler } from './controller/crawlerController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { UserController } from './controller/uesrController';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/crawler/test',
            function (request: any, response: any, next: any) {
            const args = {
                    input: {"in":"body","name":"input","required":true,"dataType":"string"},
            };
            ...
            const controller = new CrawlerControler();
        ...
        app.get('/crawler/:url',
            function (request: any, response: any, next: any) {
            const args = {
                    url: {"in":"path","name":"url","required":true,"dataType":"string"},
            };
            ...
            const promise = controller.getWeb.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/crawler',
            function (request: any, response: any, next: any) {
            const args = {
                    req: {"in":"body","name":"req","required":true,"ref":"RequestPageDTO"},
            };
            ...
            const promise = controller.crawlPage.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        ...
        app.post('/users',
            function (request: any, response: any, next: any) {
            const args = {
                    reqBody: {"in":"body","name":"reqBody","required":true,"ref":"UserCreationParams"},
            };
